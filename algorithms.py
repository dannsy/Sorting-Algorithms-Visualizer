...
if __name__ == "__main__":
    algo = Algorithms(8192 // 2)
    copy_array = algo.array.copy()
    # print(copy_array)
    algo.quick_sort()
    # print(algo.array)

    print(f"Sorted correctly? {check_sort_validity(copy_array, algo.array)}")
